...
double prism_gz(PRISM prism, double xp, double yp, double zp, int iii)
{
    double x[2], y[2], z[2], kernel, res, r, res2;
    register int i, j, k;
    double output[2];
    ...
    /* Now all that is left is to multiply res by the gravitational constant and
       density and convert it to mGal units */
    res *= G*SI2MGAL*prism.density*1000*1000;
    /**res2 *= G*SI2MGAL;*/

    output[1]=res;
    output[2]=res2;

/**printf("res est égal à %.15f %.15f %.15f %.15f %.15f \n",prism.density,G,res2,SI2MGAL,res);*/

   /**printf("On est dans grav_prism.c \n");
    printf("res est égal à %.15f %.15f \n", res,res2);*/
...
double prism_gxx(PRISM prism, double xp, double yp, double zp, int iii)
{
    double x[2], y[2], z[2], kernel, res, r, res2;
    register int i, j, k;
    double output[2];
    ...
    res *= G*SI2EOTVOS*prism.density*1000;
    res2 *= G*SI2EOTVOS;
...
double prism_gxy(PRISM prism, double xp, double yp, double zp, int iii)
{
    double x[2], y[2], z[2], kernel, res, r, xtmp, ytmp, res2;
    register int i, j, k;
    double output[2];
...
double prism_gxz(PRISM prism, double xp, double yp, double zp, int iii)
{
    double x[2], y[2], z[2], kernel, res, r, xtmp, ztmp, res2;
    register int i, j, k;
    double output[2];
...
double prism_gyy(PRISM prism, double xp, double yp, double zp, int iii)
{
    double x[2], y[2], z[2], kernel, res, r, res2;
    register int i, j, k;
    double output[2];
...
double prism_gyz(PRISM prism, double xp, double yp, double zp, int iii)
{
    double x[2], y[2], z[2], kernel, res, r, ytmp, ztmp, res2;
    register int i, j, k;
    double output[2];
...
double prism_gzz(PRISM prism, double xp, double yp, double zp, int iii)
{
    double x[2], y[2], z[2], kernel, res, r, res2;
    register int i, j, k;
    double output[2];
