...
extern double prism_gz(PRISM prism, double xp, double yp, double zp, int iii);
extern double prism_gxx(PRISM prism, double xp, double yp, double zp, int iii);
extern double prism_gxy(PRISM prism, double xp, double yp, double zp, int iii);
extern double prism_gxz(PRISM prism, double xp, double yp, double zp, int iii);
extern double prism_gyy(PRISM prism, double xp, double yp, double zp, int iii);
extern double prism_gyz(PRISM prism, double xp, double yp, double zp, int iii);
extern double prism_gzz(PRISM prism, double xp, double yp, double zp, int iii);
