...
!=====================================================================
      ...
      memory_usage_bytes = size(ADERI) * storage_size(ADERI) / 8 ! Size in bytes
      write (*,*) "Approx. memory usage for 'ADERI': ", memory_usage_bytes, " bytes"
      write(inout,*) "Approx. memory usage for 'ADERI': ", memory_usage_bytes, " bytes"
