...
!=====================================================================
      ...
      SUBROUTINE BLDMAT(iiter,aderi,bderi,cderi,punvar,varpar,h1,diff,npar,&
...
!=====================================================================
      ...
      real(kind=8),DIMENSION(npar,ndat)          :: matinter
      real(kind=8),PARAMETER                     :: one = 1.0d0
      real(kind=8),PARAMETER                     :: zero = 0.0d0
!=====================================================================
! Initialization of some arrays:
! MATINTER = INTERMEDIATE MATRIX FOR CALCULUS
...
!=====================================================================
      ...
      write(*,*)'    ....OK'
!=====================================================================
! Calculation of At*Cd**(-1)*A (of dimension nparXnpar)
! and store the result in the array CDERI for the resolution calculation
! made in RESOL subroutine
!=====================================================================
